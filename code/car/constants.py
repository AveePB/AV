...
B_IN1 = 0  # Backward input 1
B_IN2 = 0  # Backward input 2
B_IN3 = 0  # Backward input 3
B_IN4 = 0  # Backward input 4
B_ENA = 0  # Backward Enable pin A
B_ENB = 0  # Backward Enable pin B
